...
# 🔹 ประเมินช่วงเวลาจากความสว่างเฉลี่ย
...
# 🔹 วิเคราะห์เปอร์เซ็นเมฆและโอกาสฝนตกจากภาพ (OpenCV)
...
def predict():
    ...
    # แปลงเป็น BGR เพื่อใช้กับ OpenCV
    ...
    # 🔸 แปลงภาพกลับเป็น base64 สำหรับแสดงผล
    buffered = io.BytesIO()
